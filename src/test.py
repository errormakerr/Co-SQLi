...
payload_template = "D:/project/generate_payloads/data/raw_data/payloads.json"
injection_sqls_path = 'D:/project/generate_payloads/data/normal&injection/train_injection_sqls.json'
...
def cluster_payload_templates(datas_path):
    
    datas = read_json_file(datas_path)
    clusters = dict()
    for item in datas:
...
def cluster_injection_sqls(datas_path):
...
if __name__ == "__main__":
    payload_template_clusters = cluster_payload_templates(payload_template)
    injection_sql_clusters = cluster_injection_sqls(injection_sqls_path)
    ...
    print(cluster_list, "\n")
    print(clusters_reward_distribution)
